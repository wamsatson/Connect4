...
class Robots():
    ...
    def __init__(self,p1='HUMAN',p2='HUMAN',gameplay=GamePlay(),depth=3,name='mymodel_100000.h5'):
        self.depth = depth
        self.p1=p1
        self.p2=p2
...
#function to load the model
    ...
    def MiniMaxAlphaBeta_bot(self,state,player):
        try:
            ...
            return self.MiniMaxAlphaBeta(state,self.depth,player,-float("inf"),float("inf"),True)
